...
class JabatanController extends Controller
{
    ...
    public function store(Request $req)
    {
        if (Auth::user()->hasRole('admin')) {
            ...
            $attr['tingkat'] = 1;
            Jabatan::create($attr);
            toastr()->success('Struktur Organisasi Berhasil Disimpan');
        } else {
    ...
    public function update(Request $req)
    {
        ...
        toastr()->success('Struktur Organisasi Berhasil Diupdate');
        return back();
    }
    ...
    public function storeSub(Request $req)
    {
        ...
        if (Auth::user()->hasRole('admin')) {
            ...
            Jabatan::create($attr);
            toastr()->success('Sub Struktur Organisasi Berhasil Disimpan');
        } else {
            $attr = $req->all();
    ...
    public function delete($id)
    {
        try {
            ...
            toastr()->info('Struktur Organisasi Berhasil Di Hapus');
            return back();
        } catch (\Exception $e) {
            toastr()->error('Tidak bisa di hapus karena memiliki sub Struktur Organisasi');
            return back();
        }
    }
    ...
    public function destroy(Request $req)
    {
        try {
            ...
            toastr()->success('Struktur Organisasi Berhasil Di Hapus');
            return back();
        } catch (\Exception $e) {
            toastr()->error('Tidak bisa di hapus karena memiliki sub Struktur Organisasi');
            return back();
