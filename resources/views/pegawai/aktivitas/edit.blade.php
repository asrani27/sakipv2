      ...
      <div class="col-sm-12">
          <div class="box bordered-box green-border" style="margin-bottom:0;">
              ...
              <div class="box-content">
                  <form action="/pegawai/aktivitas/edit/{{$data->id}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                    @csrf
                      ...
                      <div class="col-xs-5 col-md-10">
                        <select name="kegiatan_id" class="form-control" required>
                          ...
                          @foreach ($kegiatan as $item)
                              <option value="{{$item->id}}" {{$item->id == $data->kegiatan_id ? 'selected':''}}>Tahun: {{$item->tahun->tahun}}, {{$item->nama}}</option>
                          @endforeach
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-5 col-md-10">
                        <input type="text" name="tk1" class="form-control" value="{{$data->tk1}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-5 col-md-10">
                        <input type="text" name="tk2" class="form-control" value="{{$data->tk2}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-5 col-md-10">
                        <input type="text" name="tk3" class="form-control" value="{{$data->tk3}}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-xs-5 col-md-10">
                        <input type="text" name="tk4" class="form-control" value="{{$data->tk4}}">
                      </div>
                    </div>
                    <div class="form-group">
