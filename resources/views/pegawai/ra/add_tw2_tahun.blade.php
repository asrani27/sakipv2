      ...
      <div class="col-sm-12">
          <div class="box bordered-box green-border" style="margin-bottom:0;">
              ...
              <div class="box-content">
                  <form action="/pegawai/rencana-aksi/tw2/{{$id}}/{{$tahun}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5 col-md-10">
                          <input type="text" class="form-control" name="target" value="{{$data->tw2 == null ? '': $data->tw1}}" required>
                        </div>
                    </div>
