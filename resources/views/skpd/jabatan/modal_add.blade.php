      ...
      <form method="POST" action="/admin_skpd/jabatan/add">
        ...
        <div class="modal-body">
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-4 col-form-label">Nama Struktur</label>
            <div class="col-sm-7">
              <input type="text" class="form-control" name="nama" placeholder="Dinas / Sekretariat / Bidang / Seksi"
                required>
            </div>
          </div>
        </div>
