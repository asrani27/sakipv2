      ...
      <div class="col-sm-12">
          <div class="box bordered-box green-border" style="margin-bottom:0;">
              <div class="box-header">
                  <div class="title">
                    <a href="/admin_skpd/pegawai/pk/{{$pegawai->id}}" class="btn btn-info btn-sm"> 
              ...
              <div class="box-content">
                  <form action="/admin_skpd/pegawai/pk/{{$pegawai->id}}/target/edit/{{$data->id}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-xs-5 col-md-10">
                          <input type="text" class="form-control" name="target" value="{{$data->target}}" required>
                        </div>
                    </div>
