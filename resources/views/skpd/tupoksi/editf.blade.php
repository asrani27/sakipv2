...
<div class="col-xs-12">
  <div class='page-header page-header-with-buttons'>
    <h1 class='pull-left'>
        ...
        <span>Edit Fungsi {{$jabatan->nama}}</span>
    </h1>
  </div>
    ...
    <div class="col-sm-12">
        <div class="box bordered-box green-border" style="margin-bottom:0;">
            ...
            <div class="box-content">
                <form action="/admin_skpd/fungsi/edit/{{$fungsi->id}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                  @csrf
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">Tanggal Mulai Berlaku</label>
                    <div class="col-xs-5 col-md-10">
                        <input class="form-control" name="mulai_berlaku" type="date"  value="{{$fungsi->mulai_berlaku}}">
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">Tanggal berakhir</label>
                    <div class="col-xs-5 col-md-10">
                      <input class="form-control" name="akhir_berlaku" type="date"  value="{{$fungsi->akhir_berlaku}}">
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">No</label>
                    <div class="col-xs-5 col-md-10">
                      <input class="form-control" name="no" type="text" value="{{$fungsi->no}}">
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">Isi</label>
                    <div class="col-xs-5 col-md-10">
                      <input class="form-control" name="isi" type="text" value="{{$fungsi->isi}}">
                    </div>
                  </div>                   
                  <div class="form-group">
