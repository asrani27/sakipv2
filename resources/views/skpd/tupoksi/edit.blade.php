    ...
    <div class="col-sm-12">
        <div class="box bordered-box green-border" style="margin-bottom:0;">
            ...
            <div class="box-content">
                <form action="/admin_skpd/tugas/edit/{{$tugas->id}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                  @csrf
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">Tanggal Mulai Berlaku</label>
                    <div class="col-xs-5 col-md-10">
                        <input class="form-control" name="mulai_berlaku" type="date"  value="{{$tugas->mulai_berlaku}}">
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">Tanggal berakhir</label>
                    <div class="col-xs-5 col-md-10">
                      <input class="form-control" name="akhir_berlaku" type="date" value="{{$tugas->akhir_berlaku}}">
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">No</label>
                    <div class="col-xs-5 col-md-10">
                      <input class="form-control" name="no" type="text" value="{{$tugas->no}}">
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">Isi</label>
                    <div class="col-xs-5 col-md-10">
                      <input class="form-control" name="isi" type="text" value="{{$tugas->isi}}">
                    </div>
                  </div> 
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">No Perwal</label>
                    <div class="col-xs-5 col-md-10">
                      <input class="form-control" name="perwal" type="text" value="{{$tugas->perwal}}">
                    </div>
                  </div> 
                            ...
                            <tbody>
                              @foreach ($data as $item)
                                  <tr>
                                    ...
                                    <a href="/admin_skpd/tugas/edit/{{$item->id}}" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></a> 
                                    <a href="/admin_skpd/tugas/delete/{{$item->id}}" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Ingin Di Hapus?');"><i class="fa fa-trash"></i></a> 
                                    </td>
                                  </tr>
                              @endforeach
                            </tbody>
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            ...
            <h3 class="card-title">Edit Tugas {{$jabatan->nama}}</h3>
            </div>
            <!-- /.card-header -->
            <form class="form-horizontal" method="post" action="/admin_skpd/tugas/edit/{{$tugas->id}}">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="no" value="{{$tugas->no}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Isi</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" name="isi">{{$tugas->isi}}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">No Perwal</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="perwal" value="{{$tugas->perwal}}">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" class="btn btn-sm btn-info"><i class="fas fa-save"></i> Update</button>
                </div>
                <!-- /.card-footer -->
            </form>
            <!-- /.card-body -->
