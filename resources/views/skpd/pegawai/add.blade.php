...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <form class="form-horizontal" method="post" action="/admin_skpd/pegawai/add">
                @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">NIP</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="nip" placeholder="NIP" value="{{ old('nip') }}"  minlength="18" maxlength="18" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Nama</label>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select name="pangkat_id" class="form-control">
                            <option value="">-Pilih-</option>
                            @foreach (pangkat() as $item)
                                <option value="{{$item->id}}" {{ old('pangkat_id') == $item->id ? 'selected' : '' }}>{{$item->nama}}</option>
                            @endforeach
                        </select>
                    </div>
                  </div>
