...
<div class="col-sm-12">
  <div class="box">
      ...
      <div class="box-content">
          <form action="/data/skpd/edit/{{$data->id}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
            @csrf
            <div class="form-group">
              <label class="control-label col-sm-2 col-xs-12">Kode SKPD</label>
              <div class="col-xs-5 col-md-10">
                  <input class="form-control" value="{{$data->kode_skpd}}" name="kode_skpd" type="text">
              </div>
            </div> 
            <div class="form-group">
