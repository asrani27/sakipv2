...
<div class="col-sm-12">
  <div class="box">
      ...
      <div class="box-content">
          <form action="/info/edit/{{$data->id}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
            @csrf
            <div class="form-group">
              <label class="control-label col-sm-1 col-xs-12">Judul</label>
              <div class="col-xs-5 col-md-10">
                  <input class="form-control" placeholder="Judul" name="judul" type="text" value="{{$data->judul}}">
              </div>
            </div> 
            <div class="form-group">
