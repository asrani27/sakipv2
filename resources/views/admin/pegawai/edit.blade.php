    ...
    <div class="col-sm-12">
        <div class="box bordered-box green-border" style="margin-bottom:0;">
            ...
            <div class="box-content">
                <form action="/data/pegawai/edit/{{$data->id}}" accept-charset="UTF-8" class="form form-horizontal" style="margin-bottom: 0;" method="post">
                  @csrf
                  <div class="form-group">
                    <label class="control-label col-sm-2 col-xs-12">NIP</label>
                    <div class="col-xs-5 col-md-10">
                        <input class="form-control" name="nip" value="{{$data->nip}}"  minlength="18" maxlength="18" type="text">
                    </div>
                  </div> 
                  <div class="form-group">
                    ...
                    <div class="col-xs-5 col-md-10">
                      <select name="skpd_id" class="form-control">
                          ...
                          @foreach (skpd() as $item)
                              <option value="{{$item->id}}" {{$data->skpd_id == $item->id ? 'selected' : ''}}>{{$item->nama}}</option>
                          @endforeach
                      </select>
                    </div>
                  </div>
