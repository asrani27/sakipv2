...
<div class="col-xs-12">
    <div class='page-header page-header-with-buttons'>
        <h1 class='pull-left'>
            ...
            <span>Indikator Kinerja Triwulan {{Str::limit($jabatan->nama, 40, '...')}}</span>
        </h1>
        <div class="pull-right">
            <div class="btn-group">
                <a class="btn btn-white"
                    href="/admin_skpd/kinerjatriwulan/struktur/{{$id}}/kinerja/{{$kinerja->kinerja_triwulan_id}}"><i
        ...
        <div class="col-sm-12">
            <div class="box">
                ...
                <div class="box-content">
                    <form action="/admin_skpd/kinerjatriwulan/struktur/{{$id}}/kinerja/{{$kinerja->id}}/indikator/add"
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" id="inputText"
                                value="Th :{{$kinerja->triwulan->tahun}}, Triwulan : {{$kinerja->triwulan->triwulan}}"
                                readonly>
                        </div>
                        <div class="form-group">
                            <label for="inputText">Kinerja</label>
                            <input class="form-control" name="kinerja" value="{{$kinerja->isi}}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="inputText">Indikator</label>
                            <input class="form-control" name="indikator" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="target" required>
                        </div>
                        <div class="form-group">
                            <label for="inputText">TW.I</label>
                            <input class="form-control" name="tw1" required>
                        </div>
                        <div class="form-group">
                            <label for="inputText">TW.II</label>
                            <input class="form-control" name="tw2" required>
                        </div>
                        <div class="form-group">
                            <label for="inputText">TW.III</label>
                            <input class="form-control" name="tw3" required>
                        </div>
                        <div class="form-group">
                            <label for="inputText">TW.IV</label>
                            <input class="form-control" name="tw4" required>
                        </div>
                        <div class="form-group">
                            <label for="inputText">Realisasi</label>
                            <input class="form-control" name="realisasi" required>
                        </div>
                        <div class="form-group">
                            <label for="inputText">Capaian</label>
                            <input class="form-control" name="capaian" required>
                        </div>
